...
To store your GPG key passphrase so you don't have to enter it every time you sign a commit, we recommend using the following tools:
  - For Mac users, the [GPG Suite](https://gpgtools.org/) and [GnuPG for OS X](https://gnupg.org/download/index.html) both allow you to store your GPG key passphrase in the Mac OS Keychain.
